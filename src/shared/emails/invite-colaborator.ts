interface InviteColaboratorEmailHtmlProps {
  operator_name: string
  operator_id: string
}

export const INVITE_COLABORATOR_EMAIL_HTML = (props: InviteColaboratorEmailHtmlProps) => `
  <!DOCTYPE html>
<html lang="pt-BR">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p class="message">
                Olá <span class="highlight">${props.operator_name}</span>,<br><br>
                Você foi cadastrado(a) como operador no sistema <strong>HUBELEZA</strong>. 
                Para começar a utilizar a plataforma, é necessário definir sua senha de acesso.
            </p>
            
            <div class="cta-section">
                <a href="https://panel.hubeleza.com.br/define-password?id=${props.operator_id}" class="cta-button">Definir minha senha</a>
            </div>
